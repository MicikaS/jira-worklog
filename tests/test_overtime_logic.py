...
from jira_worklog_pkg.main import _submit_worklog
...
class TestSubmitWorklogLimits(unittest.TestCase):
    ...
    @patch("jira_worklog_pkg.main.requests.post")
    @patch("jira_worklog_pkg.main._get_total_hours_on_date", return_value=None)
    ...
    @patch("jira_worklog_pkg.main.requests.post")
    @patch("jira_worklog_pkg.main._get_total_hours_on_date", return_value=5.0)
    ...
    @patch("jira_worklog_pkg.main.requests.post")
    @patch("jira_worklog_pkg.main._get_total_hours_on_date", return_value=10.0)
    ...
    @patch("jira_worklog_pkg.main.WORK_HOURS", {"Monday": 7, "Tuesday": 0, "Wednesday": 0, "Thursday": 0, "Friday": 0})
    @patch("jira_worklog_pkg.main.requests.post")
    @patch("jira_worklog_pkg.main._get_total_hours_on_date", return_value=0.0)
